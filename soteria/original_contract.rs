...
// const STAKING_PERIOD_ONE_WEEK: i64 = 120;
const STAKING_PERIOD_TWO_WEEK: i64 = 1209600;
// const STAKING_PERIOD_TWO_WEEK: i64 = 60;
const STAKING_PERIOD_FOUR_WEEK: i64 = 2419200;
// const STAKING_PERIOD_FOUR_WEEK: i64 = 60;
...
pub mod staking {
   ...
   pub fn unstake(ctx: Context<Unstake>) -> ProgramResult {
        ...
        if ctx.accounts.staking_account.reward_collected == false {
             return Err(ErrorCode::RewardNotCollected.into())
        }
    ...
    pub fn eject(ctx: Context<Eject>) -> ProgramResult {
    ...
    pub fn close(ctx: Context<Eject>) -> ProgramResult {
